...
\Fn{maximum(p\_archivos, p\_maximos, archs)}{
	...
	crear \texttt{p\_archivos} threads con una referencia a un entrada de \texttt{wrap} y a \texttt{thread\_maximum} \\
