...
A la clase \texttt{ConcurrentHashMap} le agregamos un constructor por copia y un operador de asignación, lo cual no era requerido por el enunciado necesitamos para lograr compilar los tests. A causa de esto, tuvimos que implementar también un constructor por copia para la clase \texttt{Lista}.
