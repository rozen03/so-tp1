...
Otra observación que podemos realizar es que en \textit{ej6} hay un pico en \texttt{p\_archivos = 62}. Nos fuimos capaces de determinar la causa de esta anomalía, creímos que podría tratarse algo específico de la computadora en donde realizamos las mediciones, pero probando en otras obteníamos el mismo resultado patológico.
